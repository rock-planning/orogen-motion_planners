...
#ifndef MOTION_PLANNERS_PLANNERTASK_TASK_HPP
...
namespace motion_planners{
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','motion_planners::PlannerTask')
     end
     \endverbatim
     *  It can be dynamically adapted when the deployment is called with a prefix argument.
     */
    class PlannerTask : public PlannerTaskBase
    {
        ...
        public:
             ...
             */
            PlannerTask(std::string const& name = "motion_planners::PlannerTask");
             ...
             * 
             */
            PlannerTask(std::string const& name, RTT::ExecutionEngine* engine);

            /** Default deconstructor of PlannerTask
             */
            ~PlannerTask();
